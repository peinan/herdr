...
pub(crate) fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::PaneMarkSet(_) => "pane.mark.set",
        ...
        Method::PopupScroll(_) => "popup.scroll",
        Method::PopupSelectionRead(_) => "popup.selection.read",
        Method::PopupCopyMotion(_) => "popup.copy_motion",
        Method::PopupCopySearch(_) => "popup.copy_search",
