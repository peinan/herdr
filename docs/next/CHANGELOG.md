...
- Added `ui.zoom_indicator` and `ui.zoom_indicator_position` to configure the marker shown in the zoomed pane's border title. It defaults to `Z` and an empty string hides it.
